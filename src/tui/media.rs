...
use super::{
    ...
    ui::{
        self, AvatarImage, EmojiReactionImage, ImagePreview, ImagePreviewLayout, ImagePreviewState,
    },
};
...
pub(super) struct ImagePreviewTarget {
    message_index: usize,
    preview_width: u16,
    preview_height: u16,
...
pub(super) struct EmojiImageTarget {
    url: String,
}
...
pub(super) fn visible_image_preview_targets(
    state: &DashboardState,
...
pub(super) fn visible_avatar_targets(
    state: &DashboardState,
    layout: ImagePreviewLayout,
) -> Vec<AvatarTarget> {
    let mut rendered_rows = 0usize;
...
pub(super) fn visible_emoji_image_targets(state: &DashboardState) -> Vec<EmojiImageTarget> {
...
mod tests {
    ...
    use crate::{
        ...
        tui::state::{DashboardState, FocusPane},
    };
